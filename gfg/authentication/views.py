...
def signup(request):
    ...
    if request.method == "POST":
        ...
        subject = "Welcome to Bits and Bytes Login Page!"
        message = "Hello " + myuser.Name + "Welcome to Bits and Bytes Login Page. We are glad to have you here. Hope you have a great time here. \n"
